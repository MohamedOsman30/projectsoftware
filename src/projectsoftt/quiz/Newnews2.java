 ...
 * @author M.osman
 */
public class Newnews2 {
    public void showthenewnews() {
        ...
        JLabel titleLabel = new JLabel("The Journey of Israa Fikri: Achieving Excellence Through His Master's Thesis");
        ...
        JTextArea articleContent = new JTextArea(
            ...
            "Israa Fikri, a dedicated physician, exemplifies this commitment through his recent achievement of a master's thesis. " +
